...
namespace Shop.Web.Api
{
    ...
    {
        IOrderService _TagService;
        public OrderController(IErrorService errorService, IOrderService TagService) : base(errorService)
        {
        ...
        [AllowAnonymous]
        [Route("add")]
        public HttpResponseMessage Post(HttpRequestMessage request, Order tag)
        {
            return CreateHttpRespone(request, () =>
            {
        ...
        public HttpResponseMessage Put(HttpRequestMessage request, Order tag)
        {
            return CreateHttpRespone(request, () =>
            {
                HttpResponseMessage respone = null;
